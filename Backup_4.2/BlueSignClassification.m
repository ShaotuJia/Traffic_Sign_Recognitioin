...
sampleImage = ExtractSign(sampleImage);
...
classifier = fitcecoc(BlueTrainingFeatures, BlueTrainingLabels);
...
for j = 1 : BlueTestNum
   ...
   %Extract Blue Sign
   try
   BlueImgTest = ExtractSign(BlueImgTest);
   catch
...
predictedLabels = predict(classifier, BlueTestFeatures);
